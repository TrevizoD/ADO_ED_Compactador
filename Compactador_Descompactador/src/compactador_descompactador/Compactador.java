...
import static ManipularArquivoTxt.EscreverArquivoTxt.escreverArquivo;
import static ManipularArquivoTxt.LerArquivoTxt.lerArquivo;
    ...
    public static void compactarArquivo(String caminhoArquivo) {
        ...
        for (String linhaAtual : linhasArray){
            ...
            for (String palavraAtual : palavrasLinha) {                
                ...
                //Caso essa palavra ja tenha  sido compactada, inserir no arquivo final o indice dela na lista encadeada
                if (indicePalavraJaCompactada > 0){
                    ...
                    //inserir a propria palavra no arquivo final e adiciona ela na ListaEncadeada palavrasCompactadas
