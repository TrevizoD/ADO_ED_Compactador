...
public class Compactador {
    ...
    public static void compactarArquivoTxt(String caminhoArquivo) {
        //Le o arquivo a ser compactado e separa linha por linha no array "linhasArray"
        ...
        //Itera cada linha no arquivo a ser compactado
        for (String linhaAtual : linhasArray){
            //Separa palavra por palavra no array "palavrasLinha"
            ...
            for (String palavraAtual : palavrasLinha) {                
                ...
                if (indicePalavraJaCompactada > 0){
                    ...
                    //inserir a propria palavra no arquivo final e adiciona-la na ListaEncadeada
